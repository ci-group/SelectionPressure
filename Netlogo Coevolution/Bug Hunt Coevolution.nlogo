...
bugs-own [speed vision age offspring]
birds-own [speed target eaten vision offspring sum-eaten]
...
to do-plots
  ...
  [
    ...
    file-open word "/Volumes/Slartibartfast/experiments/selection_pressure/results/bugs." runId
    ask bugs [   
        ;; log time, id, age and offspring
        file-type ticks
        file-write who
    ...
    file-open word "/Volumes/Slartibartfast/experiments/selection_pressure/results/birds." runId
    ask birds [
      ;; log time, id, age and offspring
        file-type ticks
        file-write who
...
<experiments>
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="false">
    ...
    <enumeratedValueSet variable="bug-flee-strategy">
      <value value="&quot;nearest&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="initial-bird-vision">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="initial-bug-vision">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="number-birds">
      <value value="10"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="bug-pursuit-strategy">
      <value value="&quot;nearest&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="initial-bird-speed">
      <value value="2"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="initial-bug-speed">
      <value value="2"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="bug-vision-mutation">
      <value value="0.5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="bird-speed-mutation">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="bug-speed-mutation">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="number-bugs">
      <value value="30"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="bird-vision-mutation">
      <value value="0.1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="show-vision-cone?">
      <value value="true"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="wiggle?">
      <value value="true"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="runId">
      <value value="1"/>
      <value value="3"/>
    </enumeratedValueSet>
  </experiment>
