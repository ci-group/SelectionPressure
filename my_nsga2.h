...
#ifndef PAGMO_ALGORITHM_MYNSGA2_H
#define PAGMO_ALGORITHM_MYNSGA2_H
...
class __PAGMO_VISIBLE my_nsga2: public base
{
public:
	my_nsga2(int gen=100, double cr = 0.95, double eta_c = 10, double m = 0.01, double eta_m = 50);
...
BOOST_CLASS_EXPORT_KEY(pagmo::algorithm::my_nsga2);

#endif // PAGMO_ALGORITHM_MYNSGA2_H
